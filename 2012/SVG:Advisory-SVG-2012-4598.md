---
title: SVG:Advisory-SVG-2012-4598
permalink: /SVG:Advisory-SVG-2012-4598/
---
...
A vulnerability has been found in the VOMS Java APIs where CRL checking is not correctly carried out.

This has been fixed by the developers and a new version is available.

This advisory is updated as some components required a re-release in order to fully
resolve the problem.
...
and the CRL checking was not properly carried out.
...
Additonally, in order to complete the elimination of this vulnerablity re-built components
have been released as part of UMD-2 release 2.4.1
...
2012-11-20 Assessment by the EGI Software Vulnerability Group reported to the software providers
...
2013-02-19 Removed from public web page as some components required re-build to fully
           resolve
