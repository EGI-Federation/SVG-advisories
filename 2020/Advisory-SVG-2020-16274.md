...
Title:   EGI SVG 'ALERT' **UPDATE** [TLP:WHITE] CRITICAL risk vulnerability in
         IBM GPFS file system  [EGI-SVG-2020-16274]
Date:    2020-03-13
...
A site of a peer infrastructure has identified a local privilege escalation
vulnerability in IBM GPFS.
We are aware that there are some sites within EGI which use this software,
hence the alert.
...
Sites should carry out updates as suggested by IBM Support if they have not
done so already.
...
Update to the latest version (which we are told will fix some other
vulnerabilities).
...
We are fairly sure RPM package gpfs.base-4.2.3-20 is affected by a Local
Privilege Escalation vulnerability.

All versions of GPFS 4.2.3 may be affected by a Local Privilege Escalation
vulnerability.
...
URL:   https://wiki.egi.eu/wiki/Advisory-SVG-2020-16274
...
SVG was alerted to this vulnerability by Vincent Brillault (CERN), a member of
SVG.
...
account of the increasing I nhomogeneity of the EGI infrastructure and the
