---
title: Advisory-SVG-2020-16806
permalink: /Advisory-SVG-2020-16806
---

## Advisory-SVG-2020-16806

```
Title:   EGI SVG 'ADVISORY' [TLP:WHITE] LOW risk vulnerability in dCache
         macaroon bearer token validation [EGI-SVG-2020-16806]
...
The macaroons are bearer tokens, that can contain a number of restrictions,
like READ-ONLY, VALID-UNTIL, LIMITED-TO-IP.
The result of IP based verification is not respected when it is combined with
other restrictions.
...
A fixed version dCache - 5.2.26 is available in the UMD for both SL6 and
CentOS7 in UMD-4.11.2
...
restrictions are used even less.
...
URL:   https://advisories.egi.eu/Advisory-SVG-2020-16806
...
This vulnerability was reported to SVG by Tigran Mkrtchyan from the dCache
team, who have already produced a fix.
...
2020-08-05 Assessment by the EGI Software Vulnerability Group reported to the
           software providers
