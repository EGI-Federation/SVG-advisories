---
title: SVG:Advisory-SVG-2020-16935
permalink: /SVG:Advisory-SVG-2020-16935/
---

```

Title:       EGI SVG 'ADVISORY' **UPDATE** [TLP:WHITE] CRITICAL risk DPM vulnerability allowing file deletion
             [EGI-SVG-2020-16935]
...
A vulnerability in DPM 1.14.0 and 1.14.1 allows users to delete other users' files.
...
DPM version 1.14.2, which contains a fix for this vulnerability, is available from EPEL for RHEL/SL/CentOS 7.

It is sufficient for sites just to upgrade the head nodes to address this vulnerability.
...
This vulnerability affects only DPM versions 1.14.0 and 1.14.1. It is fixed in DPM 1.14.2.
...
When the advisory was sent to sites, it additionally referred to RedHat 6 and its derivatives,
since this is past its end of life and sites should no longer be using it this has been removed.
...
URL:   https://wiki.egi.eu/wiki/SVG:Advisory-SVG-2020-16935
...
2020-11--- Discussion on situation, clarification of affected versions, and actions to take.
